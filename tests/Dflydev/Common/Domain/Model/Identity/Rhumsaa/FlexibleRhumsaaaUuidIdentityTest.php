...
use Dflydev\Common\Domain\Model\Identity\Rhumsaa\TestImpl\FlexibleRhumsaaUuidIdentity;

class FlexibleRhumsaaaUuidIdentityTest extends AbstractUuidIdTest
{
    /**
     * @test
    ...
    {
        return FlexibleRhumsaaUuidIdentity::class;
    }
}
